          ...
          >
            ...
            <Box sx={{ 
              ...
              <Box
                ...
                title="Return to Hytrade Homepage"
              >
                <img 
            ...
            <Box sx={{
              flex: '1 1 auto',
              minWidth: 0,
              maxWidth: 'calc(100vw - 400px)', // Reserve space for logo and profile button
              display: 'flex',
              alignItems: 'center',
              ...
              {[
                ...
                <Button
                  ...
                  sx={{
                    '&, &:hover, &:focus, &:active': {
                      color: '#ff3131 !important', // Force red color for all states
                    },
                    ...
                    '& .MuiButton-startIcon': {
                      mr: 0.5,
                      color: '#ff3131' // All icons are red by default
                    }
                  }}
                >
                  {item.label}
            ...
            <div style={{ 
              ...
              <button 
                ...
                onMouseOver={(e) => {
                  ...
                  e.target.style.borderColor = '#ff3131';
              ...
              >
                ...
                <div style={{
                  ...
                  boxShadow: '0 2px 4px rgba(255, 49, 49, 0.3)',
                  overflow: 'hidden',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  ...
                  <img 
                    src="/media/Images/profile placeholder.png"
                    alt="Profile"
                    style={{
                      width: '100%',
                      height: '100%',
                    ...
                    onError={(e) => {
                      ...
                      e.target.parentElement.innerHTML = `<span style="color: white; fontWeight: 600; fontSize: 14px; backgroundColor: #ff3131; width: 100%; height: 100%; display: flex; alignItems: center; justifyContent: center; borderRadius: 50%;">${user?.firstName?.charAt(0).toUpperCase() || user?.name?.charAt(0).toUpperCase() || 'S'}</span>`;
                    }}
                  />
                </div>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    {user?.firstName || user?.name || 'satendra'}
                  </div>
                  <div style={{
                    fontSize: '12px',
                    color: '#666',
